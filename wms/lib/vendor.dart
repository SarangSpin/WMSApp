...
class _VendorState extends State<Vendor> {
  ...
  SizedBox(height: 8.0),
  Text('Deadline: ${jsonRes[index]["deadline"]}', style: TextStyle(color: Colors.red)),
  SizedBox(height: 8.0),
  Text('Type: ${jsonRes[index]["type"]  ?? "N/A"}'),
  SizedBox(height: 8.0),
  Text('Name: ${jsonRes[index]["name"]}'),
  SizedBox(height: 8.0),
  Text('Start Time: ${jsonRes[index]["start_time"]}' , style: TextStyle(color: Colors.orangeAccent)),
  SizedBox(height: 8.0),
  Text('End Time: ${jsonRes[index]["end_time"]}' , style: TextStyle(color: Colors.orangeAccent)),
  SizedBox(height: 8.0),
